...
![image.png](https://upload-images.jianshu.io/upload_images/688387-43b78c4bebc6036f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
> 接口类IUserDao.java同上
> 接口实现类,目标对象UserDao是一样的,同上

在这个基础上,增加一个代理工厂类(ProxyFactory.java),将代理类写在这个地方,然后在测试类(需要使用到代理的代码)中先建立目标对象和代理对象的联系,然后代用代理对象的中同名方法
...
```
class pd.ProxyTest.staticTest.UserDao
